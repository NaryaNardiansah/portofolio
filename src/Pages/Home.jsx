...
const Home = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    social_links: [
      { icon: Github, link: "https://github.com/NaryaNardiansah" },
      { icon: Linkedin, link: "https://www.linkedin.com/in/naryan-nardiansah/" },
      { icon: Instagram, link: "https://www.instagram.com/Anasera_.kaluna/?hl=id" }
    ]
  });
      ...
      try {
        ...
        if (data) {
          ...
          setProfileData({
            ...
            social_links: [
              { icon: Github, link: data.github_url || "https://github.com/NaryaNardiansah" },
              { icon: Linkedin, link: data.linkedin_url || "https://www.linkedin.com/in/naryan-nardiansah/" },
              { icon: Instagram, link: data.instagram_url || "https://www.instagram.com/Anasera_.kaluna/?hl=id" }
            ]
          });
        }
      } catch (error) {
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen md:justify-between gap-8 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                {/* Typing Effect */}
                <TypingEffect words={profileData.subtitle} />
