...
import { User, Image, Link, FileText, Instagram, Linkedin, Github, Music, Save, Loader, Upload } from 'lucide-react';
    ...
    try {
      ...
      if (data) {
        setProfileData({
          ...
          name: data.name || 'Narya Nardiansah',
